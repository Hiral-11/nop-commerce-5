...
public class RegisterPageTest extends BaseTest {
    ...
    public static String email = getRandomString(7) + "@gmail.com";
    ...
    public void verifyThatUserShouldCreateAccountSuccessfully() throws InterruptedException {
        ...
        //Enter firstname
        registerPage.enterFirstName("Hir");
        //Enter lastname
        registerPage.enterLastName("Kar");
        Thread.sleep(3000);
        //Select day, month and year
        registerPage.selectDateOfBirth("14", "January", "1999");
        //enter email
        registerPage.enterEmail(email);
        Thread.sleep(3000);
        // enter password
        registerPage.enterPassword("Hir@kar123");
        Thread.sleep(3000);
        // enter confirm password
        registerPage.enterConfirmPassword("Hir@kar123");
        // click on  REGISTER BUTTON
        registerPage.clickOnRegisterButton();
        Thread.sleep(3000);
