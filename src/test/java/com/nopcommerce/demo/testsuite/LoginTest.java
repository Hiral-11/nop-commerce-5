...
public class LoginTest extends BaseTest {
    ...
    public void verifyTheErrorMessageWithInValidCredentials(){
        ...
        homePage.clickOnLoginLink();
        //Enter EmailId
        loginPage.enterEmailId("Hir.kar000@gmail.com");
        //Enter Password
        loginPage.enterPassword("Hir@kar111");
    ...
    public void verifyThatUserShouldLogInSuccessFullyWithValidCredentials() throws InterruptedException {
        ...
        homePage.clickOnLoginLink();
        // enter email id
        loginPage.enterEmailId("Hir.kar@gmail.com");
        // enter password
        loginPage.enterPassword("Hir@kar123");
        Thread.sleep(3000);
        //click on login button
        loginPage.clickOnLoginButton();
        Thread.sleep(3000);
